...
/// <summary>
/// Attaching this script to an object will let you trigger remote functions using NGUI events.  // 这个脚本是用来触发交互时间的 ， 找到 OnPress 触发事件后用判断来替换 
/// 
/// 
/// </summary>
...
public class UIEventTrigger : MonoBehaviour
{
    ...
    public List<EventDelegate> onPress = new List<EventDelegate>();     // 在onPress 里面是 控制按钮事件的 
